...
func (d documentRepository) GetDocumentByOwnerUUID(uid uuid.UUID, limit uint32, offset uint32, excludes models.DocumentExcludes) ([]models.Document, error) {
	if limit <= 0 {
...
func (d documentRepository) GetDocumentByDocumentUUID(documentUid, ownerUid uuid.UUID, excludes models.DocumentExcludes) (models.Document, error) {
